...
/*!
 * @file Float64TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_Float64)
{
    ...
    return_code_Float64 =
        ...
        "std_msgs::msg::dds_::Float64_", type_ids_Float64);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Float64)
    {
        StructTypeFlag struct_flags_Float64 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Float64 = "std_msgs::msg::dds_::Float64_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::Float64 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
