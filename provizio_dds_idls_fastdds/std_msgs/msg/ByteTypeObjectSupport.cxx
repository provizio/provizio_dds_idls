...
/*!
 * @file ByteTypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_Byte)
{
    ...
    return_code_Byte =
        ...
        "std_msgs::msg::dds_::Byte_", type_ids_Byte);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Byte)
    {
        StructTypeFlag struct_flags_Byte = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Byte = "std_msgs::msg::dds_::Byte_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::Byte already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
