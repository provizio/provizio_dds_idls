...
/*!
 * @file Int32TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_Int32)
{
    ...
    return_code_Int32 =
        ...
        "std_msgs::msg::dds_::Int32_", type_ids_Int32);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Int32)
    {
        StructTypeFlag struct_flags_Int32 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Int32 = "std_msgs::msg::dds_::Int32_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::Int32 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
