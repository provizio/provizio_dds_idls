...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('ColorRGBA.dll')\nif __package__ or '.' in __name__:\n    from . import _ColorRGBAWrapper\nelse:\n    import _ColorRGBAWrapper") ColorRGBA
