...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Float32MultiArray.dll')\nif __package__ or '.' in __name__:\n    from . import _Float32MultiArrayWrapper\nelse:\n    import _Float32MultiArrayWrapper") Float32MultiArray
