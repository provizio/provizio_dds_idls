...
{
    set_name("std_msgs::msg::dds_::Header_");
    uint32_t type_size = std_msgs_msg_Header_max_cdr_typesize;
...
{
    const ::std_msgs::msg::Header* p_type =
            static_cast<const ::std_msgs::msg::Header*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ::std_msgs::msg::Header* p_type =
                static_cast<::std_msgs::msg::Header*>(data);
...
{
    return reinterpret_cast<void*>(new ::std_msgs::msg::Header());
}

void HeaderPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<::std_msgs::msg::Header*>(data));
}
