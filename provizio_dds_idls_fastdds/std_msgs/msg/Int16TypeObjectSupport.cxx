...
/*!
 * @file Int16TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_Int16)
{
    ...
    return_code_Int16 =
        ...
        "std_msgs::msg::dds_::Int16_", type_ids_Int16);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Int16)
    {
        StructTypeFlag struct_flags_Int16 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Int16 = "std_msgs::msg::dds_::Int16_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::Int16 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
