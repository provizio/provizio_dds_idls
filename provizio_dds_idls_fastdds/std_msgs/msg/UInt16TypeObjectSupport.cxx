...
/*!
 * @file UInt16TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_UInt16)
{
    ...
    return_code_UInt16 =
        ...
        "std_msgs::msg::dds_::UInt16_", type_ids_UInt16);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_UInt16)
    {
        StructTypeFlag struct_flags_UInt16 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_UInt16 = "std_msgs::msg::dds_::UInt16_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::UInt16 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
