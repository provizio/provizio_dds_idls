...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('MultiArrayLayout.dll')\nif __package__ or '.' in __name__:\n    from . import _MultiArrayLayoutWrapper\nelse:\n    import _MultiArrayLayoutWrapper") MultiArrayLayout
...
%ignore std_msgs::msg::MultiArrayLayout::MultiArrayLayout(std_msgs::msg::MultiArrayLayout&&);
...
%template(MultiArrayDimension_vector) std::vector<std_msgs::msg::MultiArrayDimension>;
