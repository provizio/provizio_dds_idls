...
/*!
 * @file UInt8TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_UInt8)
{
    ...
    return_code_UInt8 =
        ...
        "std_msgs::msg::dds_::UInt8_", type_ids_UInt8);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_UInt8)
    {
        StructTypeFlag struct_flags_UInt8 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_UInt8 = "std_msgs::msg::dds_::UInt8_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::UInt8 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
