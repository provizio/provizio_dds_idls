...
/*!
 * @file UInt32TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_UInt32)
{
    ...
    return_code_UInt32 =
        ...
        "std_msgs::msg::dds_::UInt32_", type_ids_UInt32);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_UInt32)
    {
        StructTypeFlag struct_flags_UInt32 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_UInt32 = "std_msgs::msg::dds_::UInt32_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::UInt32 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
