        ...
        TypeIdentifierPair& type_ids_String)
{
    ...
    return_code_String =
        ...
        "std_msgs::msg::dds_::String_", type_ids_String);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_String)
    {
        StructTypeFlag struct_flags_String = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_String = "std_msgs::msg::dds_::String_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::String already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
