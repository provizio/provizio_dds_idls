...
/*!
 * @file UInt8MultiArray.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.3.0).
 */

#ifndef FAST_DDS_GENERATED__STD_MSGS_MSG_UINT8MULTIARRAY_HPP
#define FAST_DDS_GENERATED__STD_MSGS_MSG_UINT8MULTIARRAY_HPP
...
public:
     ...
     * @param x Reference to the object UInt8MultiArray that will be copied.
     */
    eProsima_user_DllExport UInt8MultiArray(
     ...
     * @param x UInt8MultiArray object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_STD_MSGS_MSG_UINT8MULTIARRAY_HPP_
