...
/*!
 * @file UInt64TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_UInt64)
{
    ...
    return_code_UInt64 =
        ...
        "std_msgs::msg::dds_::UInt64_", type_ids_UInt64);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_UInt64)
    {
        StructTypeFlag struct_flags_UInt64 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_UInt64 = "std_msgs::msg::dds_::UInt64_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::UInt64 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
