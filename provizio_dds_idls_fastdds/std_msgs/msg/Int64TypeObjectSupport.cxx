...
/*!
 * @file Int64TypeObjectSupport.cxx
        ...
        TypeIdentifierPair& type_ids_Int64)
{
    ...
    return_code_Int64 =
        ...
        "std_msgs::msg::dds_::Int64_", type_ids_Int64);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Int64)
    {
        StructTypeFlag struct_flags_Int64 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Int64 = "std_msgs::msg::dds_::Int64_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "std_msgs::msg::Int64 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
