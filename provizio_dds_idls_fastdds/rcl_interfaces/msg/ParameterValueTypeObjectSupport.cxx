        ...
        TypeIdentifierPair& type_ids_ParameterValue)
{
    ...
    return_code_ParameterValue =
        ...
        "rcl_interfaces::msg::dds_::ParameterValue_", type_ids_ParameterValue);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_ParameterValue)
    {
        StructTypeFlag struct_flags_ParameterValue = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_ParameterValue = "rcl_interfaces::msg::dds_::ParameterValue_";
