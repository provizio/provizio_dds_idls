...
/*!
 * @file ParameterTypePubSubTypes.hpp
...
#ifndef FAST_DDS_GENERATED__RCL_INTERFACES_MSG_PARAMETERTYPE_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__RCL_INTERFACES_MSG_PARAMETERTYPE_PUBSUBTYPES_HPP
...
struct ParameterType_f
{
    typedef uint8_t ParameterType::* type;
    friend constexpr type get(
            ParameterType_f);
};

template struct ParameterType_rob<ParameterType_f, &ParameterType::m_structure_needs_at_least_one_member>;

template <typename T, typename Tag>
inline size_t constexpr ParameterType_offset_of()
{
...
public:
    ...
    typedef ::rcl_interfaces::msg::ParameterType type;

    eProsima_user_DllExport ParameterTypePubSubType();

    eProsima_user_DllExport ~ParameterTypePubSubType() override;
...
private:
    ...
    {
        return 1ULL ==
               (detail::ParameterType_offset_of<ParameterType, detail::ParameterType_f>() +
               sizeof(uint8_t));
    }
...
#endif // FAST_DDS_GENERATED__RCL_INTERFACES_MSG_PARAMETERTYPE_PUBSUBTYPES_HPP
