...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('FloatingPointRange.dll')\nif __package__ or '.' in __name__:\n    from . import _FloatingPointRangeWrapper\nelse:\n    import _FloatingPointRangeWrapper") FloatingPointRange
...
%ignore rcl_interfaces::msg::FloatingPointRange::FloatingPointRange(rcl_interfaces::msg::FloatingPointRange&&);
