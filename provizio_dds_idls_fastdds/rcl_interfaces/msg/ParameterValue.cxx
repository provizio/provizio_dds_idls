...
rcl_interfaces::msg::ParameterValue::ParameterValue()
{
    // uint8 m_type
    m_type = 0;
    // boolean m_bool_value
    m_bool_value = false;
    // long long m_integer_value
    m_integer_value = 0;
    // double m_double_value
    m_double_value = 0.0;
    // string m_string_value
    m_string_value ="";
    // sequence<octet> m_byte_array_value

    // sequence<boolean> m_bool_array_value

    // sequence<long long> m_integer_array_value

    // sequence<double> m_double_array_value

    // sequence<string> m_string_array_value
        ...
        size_t current_alignment)
{
    ...
    return rcl_interfaces_msg_ParameterValue_max_cdr_typesize;
}
...
{
    static_cast<void>(current_alignment);
    return rcl_interfaces_msg_ParameterValue_max_key_cdr_typesize;
}
