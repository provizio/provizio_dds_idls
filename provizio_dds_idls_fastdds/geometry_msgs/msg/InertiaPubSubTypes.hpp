...
#ifndef FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_INERTIA_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_INERTIA_PUBSUBTYPES_HPP
...
public:
    ...
    typedef ::geometry_msgs::msg::Inertia type;

    eProsima_user_DllExport InertiaPubSubType();

    eProsima_user_DllExport ~InertiaPubSubType() override;
...
private:
    ...
    {
        return 80ULL ==
               (detail::Inertia_offset_of<Inertia, detail::Inertia_f>() +
               sizeof(double));
    }
...
#endif // FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_INERTIA_PUBSUBTYPES_HPP
