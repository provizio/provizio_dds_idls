...
/*!
 * @file AccelStamped.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.3.0).
 */

#ifndef FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_ACCELSTAMPED_HPP
#define FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_ACCELSTAMPED_HPP
...
public:
     ...
     * @param x Reference to the object AccelStamped that will be copied.
     */
    eProsima_user_DllExport AccelStamped(
     ...
     * @param x AccelStamped object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_GEOMETRY_MSGS_MSG_ACCELSTAMPED_HPP_
