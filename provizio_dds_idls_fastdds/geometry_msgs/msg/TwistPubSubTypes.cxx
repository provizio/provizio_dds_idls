...
namespace geometry_msgs {
    namespace msg {
        TwistPubSubType::TwistPubSubType()
        {
            ...
            uint32_t keyLength = geometry_msgs_msg_Twist_max_key_cdr_typesize > 16 ? geometry_msgs_msg_Twist_max_key_cdr_typesize : 16;
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    geometry_msgs_msg_Twist_max_key_cdr_typesize);

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            eprosima::fastcdr::serialize_key(ser, *p_type);
            if (force_md5 || geometry_msgs_msg_Twist_max_key_cdr_typesize > 16)
            {
                m_md5.init();
