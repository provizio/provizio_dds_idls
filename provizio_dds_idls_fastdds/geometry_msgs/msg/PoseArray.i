...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('PoseArray.dll')\nif __package__ or '.' in __name__:\n    from . import _PoseArrayWrapper\nelse:\n    import _PoseArrayWrapper") PoseArray
...
%template(Pose_vector) std::vector<geometry_msgs::msg::Pose>;
