...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('TwistStamped.dll')\nif __package__ or '.' in __name__:\n    from . import _TwistStampedWrapper\nelse:\n    import _TwistStampedWrapper") TwistStamped
...
%ignore geometry_msgs::msg::TwistStamped::TwistStamped(geometry_msgs::msg::TwistStamped&&);
