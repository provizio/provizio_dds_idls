...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('AccelStamped.dll')\nif __package__ or '.' in __name__:\n    from . import _AccelStampedWrapper\nelse:\n    import _AccelStampedWrapper") AccelStamped
...
%include "geometry_msgs/msg/Accel.i"
