...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('AccelWithCovariance.dll')\nif __package__ or '.' in __name__:\n    from . import _AccelWithCovarianceWrapper\nelse:\n    import _AccelWithCovarianceWrapper") AccelWithCovariance
...
%ignore geometry_msgs::msg::AccelWithCovariance::AccelWithCovariance(geometry_msgs::msg::AccelWithCovariance&&);
...
%ignore geometry_msgs::msg::AccelWithCovariance::covariance(geometry_msgs::msg::AccelWithCovariance__double__36&&);
