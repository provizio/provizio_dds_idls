...
void register_Point32_type_identifier(
        TypeIdentifierPair& type_ids_Point32)
{

    ReturnCode_t return_code_Point32 {eprosima::fastdds::dds::RETCODE_OK};
    return_code_Point32 =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "geometry_msgs::msg::dds_::Point32_", type_ids_Point32);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Point32)
    {
        StructTypeFlag struct_flags_Point32 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Point32 = "geometry_msgs::msg::dds_::Point32_";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_Point32;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_Point32;
        CompleteTypeDetail detail_Point32 = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_Point32, ann_custom_Point32, type_name_Point32.to_string());
        CompleteStructHeader header_Point32;
        header_Point32 = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_Point32);
        CompleteStructMemberSeq member_seq_Point32;
        {
            ...
            ann_custom_Point32.reset();
            CompleteMemberDetail detail_x = TypeObjectUtils::build_complete_member_detail(name_x, member_ann_builtin_x, ann_custom_Point32);
            CompleteStructMember member_x = TypeObjectUtils::build_complete_struct_member(common_x, detail_x);
            TypeObjectUtils::add_complete_struct_member(member_seq_Point32, member_x);
        }
        {
            ...
            ann_custom_Point32.reset();
            CompleteMemberDetail detail_y = TypeObjectUtils::build_complete_member_detail(name_y, member_ann_builtin_y, ann_custom_Point32);
            CompleteStructMember member_y = TypeObjectUtils::build_complete_struct_member(common_y, detail_y);
            TypeObjectUtils::add_complete_struct_member(member_seq_Point32, member_y);
        }
        {
            ...
            ann_custom_Point32.reset();
            CompleteMemberDetail detail_z = TypeObjectUtils::build_complete_member_detail(name_z, member_ann_builtin_z, ann_custom_Point32);
            CompleteStructMember member_z = TypeObjectUtils::build_complete_struct_member(common_z, detail_z);
            TypeObjectUtils::add_complete_struct_member(member_seq_Point32, member_z);
        }
        CompleteStructType struct_type_Point32 = TypeObjectUtils::build_complete_struct_type(struct_flags_Point32, header_Point32, member_seq_Point32);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_Point32, type_name_Point32.to_string(), type_ids_Point32))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "geometry_msgs::msg::Point32 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
