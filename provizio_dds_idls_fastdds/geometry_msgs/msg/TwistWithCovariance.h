...
namespace geometry_msgs {
    namespace msg {
        ...
        public:
             ...
             */
            eProsima_user_DllExport const geometry_msgs::msg::double36& covariance() const;

            /*!
             * @brief This function returns a reference to member covariance
             * @return Reference to member covariance
             */
            eProsima_user_DllExport geometry_msgs::msg::double36& covariance();

        private:

            geometry_msgs::msg::Twist m_twist;
            geometry_msgs::msg::double36 m_covariance{0.0};
