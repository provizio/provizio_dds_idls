...
namespace geometry_msgs {
    namespace msg {
        PoseArrayPubSubType::PoseArrayPubSubType()
        {
            ...
            uint32_t keyLength = geometry_msgs_msg_PoseArray_max_key_cdr_typesize > 16 ? geometry_msgs_msg_PoseArray_max_key_cdr_typesize : 16;
            ...
            return [data, data_representation]() -> uint32_t
                   {
                       ...
                       return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                   *static_cast<PoseArray*>(data), current_alignment)) +
                               4u /*encapsulation*/;
                   };
        }
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    geometry_msgs_msg_PoseArray_max_key_cdr_typesize);

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            eprosima::fastcdr::serialize_key(ser, *p_type);
            if (force_md5 || geometry_msgs_msg_PoseArray_max_key_cdr_typesize > 16)
            {
                m_md5.init();
