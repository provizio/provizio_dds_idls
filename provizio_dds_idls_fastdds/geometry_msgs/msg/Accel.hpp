...
#ifndef FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_ACCEL_HPP
#define FAST_DDS_GENERATED__GEOMETRY_MSGS_MSG_ACCEL_HPP
...
public:
     ...
     * @param x Reference to the object Accel that will be copied.
     */
    eProsima_user_DllExport Accel(
            const Accel& x)
    {
     ...
     * @param x Accel object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_GEOMETRY_MSGS_MSG_ACCEL_HPP_
