...
void register_Vector3_type_identifier(
        TypeIdentifierPair& type_ids_Vector3)
{

    ReturnCode_t return_code_Vector3 {eprosima::fastdds::dds::RETCODE_OK};
    return_code_Vector3 =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "geometry_msgs::msg::dds_::Vector3_", type_ids_Vector3);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Vector3)
    {
        StructTypeFlag struct_flags_Vector3 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Vector3 = "geometry_msgs::msg::dds_::Vector3_";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_Vector3;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_Vector3;
        CompleteTypeDetail detail_Vector3 = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_Vector3, ann_custom_Vector3, type_name_Vector3.to_string());
        CompleteStructHeader header_Vector3;
        header_Vector3 = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_Vector3);
        CompleteStructMemberSeq member_seq_Vector3;
        {
        ...
        }
        {
            ...
            ann_custom_Vector3.reset();
            CompleteMemberDetail detail_y = TypeObjectUtils::build_complete_member_detail(name_y, member_ann_builtin_y, ann_custom_Vector3);
            CompleteStructMember member_y = TypeObjectUtils::build_complete_struct_member(common_y, detail_y);
            TypeObjectUtils::add_complete_struct_member(member_seq_Vector3, member_y);
        }
        {
            ...
            ann_custom_Vector3.reset();
            CompleteMemberDetail detail_z = TypeObjectUtils::build_complete_member_detail(name_z, member_ann_builtin_z, ann_custom_Vector3);
            CompleteStructMember member_z = TypeObjectUtils::build_complete_struct_member(common_z, detail_z);
            TypeObjectUtils::add_complete_struct_member(member_seq_Vector3, member_z);
        }
        CompleteStructType struct_type_Vector3 = TypeObjectUtils::build_complete_struct_type(struct_flags_Vector3, header_Vector3, member_seq_Vector3);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_Vector3, type_name_Vector3.to_string(), type_ids_Vector3))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "geometry_msgs::msg::Vector3 already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
