...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('QuaternionStamped.dll')\nif __package__ or '.' in __name__:\n    from . import _QuaternionStampedWrapper\nelse:\n    import _QuaternionStampedWrapper") QuaternionStamped
...
%ignore geometry_msgs::msg::QuaternionStamped::QuaternionStamped(geometry_msgs::msg::QuaternionStamped&&);
