...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Point.dll')\nif __package__ or '.' in __name__:\n    from . import _PointWrapper\nelse:\n    import _PointWrapper") Point
...
%ignore geometry_msgs::msg::Point::Point(geometry_msgs::msg::Point&&);
