...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Twist.dll')\nif __package__ or '.' in __name__:\n    from . import _TwistWrapper\nelse:\n    import _TwistWrapper") Twist
...
%ignore geometry_msgs::msg::Twist::Twist(geometry_msgs::msg::Twist&&);
