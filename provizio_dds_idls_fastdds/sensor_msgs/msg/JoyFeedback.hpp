...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOYFEEDBACK_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOYFEEDBACK_HPP
...
public:
     ...
     * @param x Reference to the object JoyFeedback that will be copied.
     */
    eProsima_user_DllExport JoyFeedback(
            const JoyFeedback& x)
    {
     ...
     * @param x JoyFeedback object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_JOYFEEDBACK_HPP_
