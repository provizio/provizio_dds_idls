...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Temperature.dll')\nif __package__ or '.' in __name__:\n    from . import _TemperatureWrapper\nelse:\n    import _TemperatureWrapper") Temperature
