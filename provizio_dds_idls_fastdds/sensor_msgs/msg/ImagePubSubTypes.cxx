...
{
    set_name("sensor_msgs::msg::dds_::Image_");
    uint32_t type_size = sensor_msgs_msg_Image_max_cdr_typesize;
...
{
    const ::sensor_msgs::msg::Image* p_type =
            static_cast<const ::sensor_msgs::msg::Image*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ::sensor_msgs::msg::Image* p_type =
                static_cast<::sensor_msgs::msg::Image*>(data);
...
{
    return reinterpret_cast<void*>(new ::sensor_msgs::msg::Image());
}

void ImagePubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<::sensor_msgs::msg::Image*>(data));
}
