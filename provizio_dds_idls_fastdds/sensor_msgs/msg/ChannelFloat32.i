...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('ChannelFloat32.dll')\nif __package__ or '.' in __name__:\n    from . import _ChannelFloat32Wrapper\nelse:\n    import _ChannelFloat32Wrapper") ChannelFloat32
