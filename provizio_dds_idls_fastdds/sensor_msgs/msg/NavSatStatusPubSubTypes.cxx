...
namespace sensor_msgs {
    namespace msg {
        ...
        NavSatStatusPubSubType::NavSatStatusPubSubType()
        {
            ...
            uint32_t keyLength = sensor_msgs_msg_NavSatStatus_max_key_cdr_typesize > 16 ? sensor_msgs_msg_NavSatStatus_max_key_cdr_typesize : 16;
            ...
            return [data, data_representation]() -> uint32_t
                   {
                       ...
                       return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                   *static_cast<NavSatStatus*>(data), current_alignment)) +
                               4u /*encapsulation*/;
                   };
        }
                ...
                bool force_md5)
        {
            ...
            if (force_md5 || sensor_msgs_msg_NavSatStatus_max_key_cdr_typesize > 16)
            {
                m_md5.init();
