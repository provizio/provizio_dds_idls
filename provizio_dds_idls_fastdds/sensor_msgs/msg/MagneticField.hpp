...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_MAGNETICFIELD_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_MAGNETICFIELD_HPP
...
typedef std::array<double, 9> MagneticField__double__9;
...
public:
     ...
     * @param x Reference to the object MagneticField that will be copied.
     */
    eProsima_user_DllExport MagneticField(
     ...
     * @param x MagneticField object to compare.
     */
    ...
    eProsima_user_DllExport void magnetic_field_covariance(
            const MagneticField__double__9& _magnetic_field_covariance)
    {
     ...
     */
    eProsima_user_DllExport void magnetic_field_covariance(
            MagneticField__double__9&& _magnetic_field_covariance)
    {
     ...
     */
    eProsima_user_DllExport const MagneticField__double__9& magnetic_field_covariance() const
    {
     ...
     */
    eProsima_user_DllExport MagneticField__double__9& magnetic_field_covariance()
    {
        return m_magnetic_field_covariance;
    }
...
private:
    ...
    MagneticField__double__9 m_magnetic_field_covariance{0.0};
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_MAGNETICFIELD_HPP_
