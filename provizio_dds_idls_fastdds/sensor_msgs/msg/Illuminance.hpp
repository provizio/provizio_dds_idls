...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_ILLUMINANCE_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_ILLUMINANCE_HPP
...
public:
     ...
     * @param x Reference to the object Illuminance that will be copied.
     */
    eProsima_user_DllExport Illuminance(
            const Illuminance& x)
    {
     ...
     * @param x Illuminance object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_ILLUMINANCE_HPP_
