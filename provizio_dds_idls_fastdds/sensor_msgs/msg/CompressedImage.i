...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('CompressedImage.dll')\nif __package__ or '.' in __name__:\n    from . import _CompressedImageWrapper\nelse:\n    import _CompressedImageWrapper") CompressedImage
