...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('RegionOfInterest.dll')\nif __package__ or '.' in __name__:\n    from . import _RegionOfInterestWrapper\nelse:\n    import _RegionOfInterestWrapper") RegionOfInterest
...
%ignore sensor_msgs::msg::RegionOfInterest::RegionOfInterest(sensor_msgs::msg::RegionOfInterest&&);
