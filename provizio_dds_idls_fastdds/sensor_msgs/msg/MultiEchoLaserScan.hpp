...
/*!
 * @file MultiEchoLaserScan.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.3.0).
 */

#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_MULTIECHOLASERSCAN_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_MULTIECHOLASERSCAN_HPP
...
public:
     ...
     * @param x Reference to the object MultiEchoLaserScan that will be copied.
     */
    eProsima_user_DllExport MultiEchoLaserScan(
     ...
     * @param x MultiEchoLaserScan object to compare.
     */
    ...
    eProsima_user_DllExport void ranges(
            const std::vector<LaserEcho>& _ranges)
    {
        m_ranges = _ranges;
    }
     ...
     */
    eProsima_user_DllExport const std::vector<LaserEcho>& ranges() const
    {
        return m_ranges;
    }
     ...
     */
    eProsima_user_DllExport std::vector<LaserEcho>& ranges()
    {
        return m_ranges;
    }
    ...
    eProsima_user_DllExport void intensities(
            const std::vector<LaserEcho>& _intensities)
    {
     ...
     */
    eProsima_user_DllExport void intensities(
            std::vector<LaserEcho>&& _intensities)
    {
     ...
     */
    eProsima_user_DllExport const std::vector<LaserEcho>& intensities() const
    {
     ...
     */
    eProsima_user_DllExport std::vector<LaserEcho>& intensities()
    {
        return m_intensities;
    }
...
private:
    ...
    std::vector<LaserEcho> m_ranges;
    std::vector<LaserEcho> m_intensities;
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_MULTIECHOLASERSCAN_HPP_
