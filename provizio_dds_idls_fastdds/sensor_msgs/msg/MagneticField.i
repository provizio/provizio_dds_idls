...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('MagneticField.dll')\nif __package__ or '.' in __name__:\n    from . import _MagneticFieldWrapper\nelse:\n    import _MagneticFieldWrapper") MagneticField
...
%ignore sensor_msgs::msg::MagneticField::magnetic_field_covariance(sensor_msgs::msg::MagneticField__double__9&&);
