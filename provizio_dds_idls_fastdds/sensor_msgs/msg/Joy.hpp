...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOY_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOY_HPP
...
public:
     ...
     * @param x Reference to the object Joy that will be copied.
     */
    eProsima_user_DllExport Joy(
            const Joy& x)
    {
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_JOY_HPP_
