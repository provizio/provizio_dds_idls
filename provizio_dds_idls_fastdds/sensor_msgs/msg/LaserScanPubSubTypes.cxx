...
namespace sensor_msgs {
    namespace msg {
        LaserScanPubSubType::LaserScanPubSubType()
        {
            ...
            uint32_t keyLength = sensor_msgs_msg_LaserScan_max_key_cdr_typesize > 16 ? sensor_msgs_msg_LaserScan_max_key_cdr_typesize : 16;
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    sensor_msgs_msg_LaserScan_max_key_cdr_typesize);

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            eprosima::fastcdr::serialize_key(ser, *p_type);
            if (force_md5 || sensor_msgs_msg_LaserScan_max_key_cdr_typesize > 16)
            {
                m_md5.init();
