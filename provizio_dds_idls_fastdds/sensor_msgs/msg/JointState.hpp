...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOINTSTATE_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_JOINTSTATE_HPP
...
public:
     ...
     * @param x Reference to the object JointState that will be copied.
     */
    eProsima_user_DllExport JointState(
            const JointState& x)
    {
     ...
     * @param x JointState object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_JOINTSTATE_HPP_
