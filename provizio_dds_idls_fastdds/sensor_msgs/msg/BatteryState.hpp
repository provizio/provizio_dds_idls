...
#ifndef FAST_DDS_GENERATED__SENSOR_MSGS_MSG_BATTERYSTATE_HPP
#define FAST_DDS_GENERATED__SENSOR_MSGS_MSG_BATTERYSTATE_HPP
...
public:
     ...
     * @param x Reference to the object BatteryState that will be copied.
     */
    eProsima_user_DllExport BatteryState(
     ...
     * @param x BatteryState object to compare.
     */
...
private:
    ...
    float m_design_capacity{0.0};
    float m_percentage{0.0};
    uint8_t m_power_supply_status{0};
    uint8_t m_power_supply_health{0};
    uint8_t m_power_supply_technology{0};
...
#endif // _FAST_DDS_GENERATED_SENSOR_MSGS_MSG_BATTERYSTATE_HPP_
