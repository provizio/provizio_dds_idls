...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('JointState.dll')\nif __package__ or '.' in __name__:\n    from . import _JointStateWrapper\nelse:\n    import _JointStateWrapper") JointState
