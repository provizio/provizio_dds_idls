...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('GetPlan.dll')\nif __package__ or '.' in __name__:\n    from . import _GetPlanWrapper\nelse:\n    import _GetPlanWrapper") GetPlan
...
%ignore nav_msgs::srv::GetPlan_Request::GetPlan_Request(nav_msgs::srv::GetPlan_Request&&);
...
// Ignore overloaded methods that have no application on Python
// Otherwise they will issue a warning
%ignore nav_msgs::srv::GetPlan_Response::GetPlan_Response(nav_msgs::srv::GetPlan_Response&&);
