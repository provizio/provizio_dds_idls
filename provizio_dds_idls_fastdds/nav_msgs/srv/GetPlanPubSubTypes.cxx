...
namespace nav_msgs {
    namespace srv {
        GetPlan_RequestPubSubType::GetPlan_RequestPubSubType()
        {
            ...
            uint32_t keyLength = nav_msgs_srv_GetPlan_Request_max_key_cdr_typesize > 16 ? nav_msgs_srv_GetPlan_Request_max_key_cdr_typesize : 16;
            ...
            return [data, data_representation]() -> uint32_t
                   {
                       ...
                       return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                   *static_cast<GetPlan_Request*>(data), current_alignment)) +
                               4u /*encapsulation*/;
                   };
        }
                ...
                bool force_md5)
        {
            ...
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    nav_msgs_srv_GetPlan_Request_max_key_cdr_typesize);

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            eprosima::fastcdr::serialize_key(ser, *p_type);
            if (force_md5 || nav_msgs_srv_GetPlan_Request_max_key_cdr_typesize > 16)
            {
                m_md5.init();
        ...
        GetPlan_ResponsePubSubType::GetPlan_ResponsePubSubType()
        {
            ...
            m_typeSize = type_size + 4; /*encapsulation*/
            m_isGetKeyDefined = false;
            uint32_t keyLength = nav_msgs_srv_GetPlan_Response_max_key_cdr_typesize > 16 ? nav_msgs_srv_GetPlan_Response_max_key_cdr_typesize : 16;
            m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
            memset(m_keyBuffer, 0, keyLength);
        }
            ...
            return [data, data_representation]() -> uint32_t
                   {
                       ...
                       size_t current_alignment {0};
                       return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                   *static_cast<GetPlan_Response*>(data), current_alignment)) +
                               4u /*encapsulation*/;
                   };
        }
                ...
                bool force_md5)
        {
            ...
            // Object that manages the raw buffer.
            eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
                    nav_msgs_srv_GetPlan_Response_max_key_cdr_typesize);

            // Object that serializes the data.
            eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
            eprosima::fastcdr::serialize_key(ser, *p_type);
            if (force_md5 || nav_msgs_srv_GetPlan_Response_max_key_cdr_typesize > 16)
            {
                m_md5.init();
                m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.get_serialized_data_length()));
                m_md5.finalize();
