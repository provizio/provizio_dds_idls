...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('GridCells.dll')\nif __package__ or '.' in __name__:\n    from . import _GridCellsWrapper\nelse:\n    import _GridCellsWrapper") GridCells
...
%ignore nav_msgs::msg::GridCells::GridCells(nav_msgs::msg::GridCells&&);
...
%template(Point_vector) std::vector<geometry_msgs::msg::Point>;
