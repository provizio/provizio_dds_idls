...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('MapMetaData.dll')\nif __package__ or '.' in __name__:\n    from . import _MapMetaDataWrapper\nelse:\n    import _MapMetaDataWrapper") MapMetaData
