...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Odometry.dll')\nif __package__ or '.' in __name__:\n    from . import _OdometryWrapper\nelse:\n    import _OdometryWrapper") Odometry
...
%ignore nav_msgs::msg::Odometry::Odometry(nav_msgs::msg::Odometry&&);
