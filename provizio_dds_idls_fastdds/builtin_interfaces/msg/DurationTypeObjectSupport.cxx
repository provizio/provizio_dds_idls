...
void register_Duration_type_identifier(
        TypeIdentifierPair& type_ids_Duration)
{

    ReturnCode_t return_code_Duration {eprosima::fastdds::dds::RETCODE_OK};
    return_code_Duration =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "builtin_interfaces::msg::dds_::Duration_", type_ids_Duration);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Duration)
    {
        StructTypeFlag struct_flags_Duration = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Duration = "builtin_interfaces::msg::dds_::Duration_";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_Duration;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_Duration;
        CompleteTypeDetail detail_Duration = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_Duration, ann_custom_Duration, type_name_Duration.to_string());
        CompleteStructHeader header_Duration;
        header_Duration = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_Duration);
        CompleteStructMemberSeq member_seq_Duration;
        {
            ...
            ann_custom_Duration.reset();
            CompleteMemberDetail detail_sec = TypeObjectUtils::build_complete_member_detail(name_sec, member_ann_builtin_sec, ann_custom_Duration);
            CompleteStructMember member_sec = TypeObjectUtils::build_complete_struct_member(common_sec, detail_sec);
            TypeObjectUtils::add_complete_struct_member(member_seq_Duration, member_sec);
        }
        {
            ...
            ann_custom_Duration.reset();
            CompleteMemberDetail detail_nanosec = TypeObjectUtils::build_complete_member_detail(name_nanosec, member_ann_builtin_nanosec, ann_custom_Duration);
            CompleteStructMember member_nanosec = TypeObjectUtils::build_complete_struct_member(common_nanosec, detail_nanosec);
            TypeObjectUtils::add_complete_struct_member(member_seq_Duration, member_nanosec);
        }
        CompleteStructType struct_type_Duration = TypeObjectUtils::build_complete_struct_type(struct_flags_Duration, header_Duration, member_seq_Duration);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_Duration, type_name_Duration.to_string(), type_ids_Duration))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "builtin_interfaces::msg::Duration already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
