        ...
        TypeIdentifierPair& type_ids_Time)
{
    ...
    return_code_Time =
        ...
        "builtin_interfaces::msg::dds_::Time_", type_ids_Time);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Time)
    {
        StructTypeFlag struct_flags_Time = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_Time = "builtin_interfaces::msg::dds_::Time_";
        ...
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "builtin_interfaces::msg::Time already registered in TypeObjectRegistry for a different type.");
        }
    }
}
} // namespace msg
