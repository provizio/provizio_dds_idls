...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('Trigger.dll')\nif __package__ or '.' in __name__:\n    from . import _TriggerWrapper\nelse:\n    import _TriggerWrapper") Trigger
