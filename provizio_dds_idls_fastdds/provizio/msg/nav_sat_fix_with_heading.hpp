...
/*!
 * @file nav_sat_fix_with_heading.hpp
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool fastddsgen (version: 4.3.0).
 */

#ifndef FAST_DDS_GENERATED__PROVIZIO_MSG_NAV_SAT_FIX_WITH_HEADING_HPP
#define FAST_DDS_GENERATED__PROVIZIO_MSG_NAV_SAT_FIX_WITH_HEADING_HPP
...
public:
     ...
     * @param x Reference to the object nav_sat_fix_with_heading that will be copied.
     */
    eProsima_user_DllExport nav_sat_fix_with_heading(
     ...
     * @param x nav_sat_fix_with_heading object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_PROVIZIO_MSG_NAV_SAT_FIX_WITH_HEADING_HPP_
