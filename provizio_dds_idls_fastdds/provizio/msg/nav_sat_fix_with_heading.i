...
%module(moduleimport="if __import__('os').name == 'nt': import win32api; win32api.LoadLibrary('nav_sat_fix_with_heading.dll')\nif __package__ or '.' in __name__:\n    from . import _nav_sat_fix_with_headingWrapper\nelse:\n    import _nav_sat_fix_with_headingWrapper") nav_sat_fix_with_heading
