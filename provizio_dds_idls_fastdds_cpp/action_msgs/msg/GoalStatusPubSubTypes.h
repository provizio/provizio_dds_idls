...
namespace actionlib_msgs
{
    namespace msg
    {
        ...
        /*!
         * @brief This class represents the TopicDataType of the type GoalStatus defined by the user in the IDL file.
         * @ingroup GOALSTATUS
         */
        class GoalStatusPubSubType : public eprosima::fastdds::dds::TopicDataType
        {
        public:

            typedef GoalStatus type;

            eProsima_user_DllExport GoalStatusPubSubType();

            eProsima_user_DllExport virtual ~GoalStatusPubSubType() override;
